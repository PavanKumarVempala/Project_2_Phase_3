...
namespace Project_1.Controllers
{
    ...
    {
        private readonly EMSdatabaseContext _context;

        public EmpProfilesController(EMSdatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<EmpProfile>> PostEmpProfile(EmpProfile empProfile)
        {
          if (_context.EmpProfiles == null)
          {
              return Problem("Entity set 'EMSdatabaseContext.EmpProfiles'  is null.");
          }
